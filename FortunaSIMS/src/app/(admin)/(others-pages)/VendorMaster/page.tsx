...
export default function VendorMasterListPage() {
  const [data, setData] = useState<Vendor[]>([
    { code: "VEN-001", name: "Sri Lakshmi Suppliers", category: "Raw Material", tier: "Tier 1", phone: "9000011111", city: "Hyderabad", status: "Active" },
    { code: "VEN-002", name: "Aparna Packaging", category: "Packaging", tier: "Tier 2", phone: "9000022222", city: "Vizag", status: "Active" },
    { code: "VEN-003", name: "FastLine Transport", category: "Transport", tier: "Tier 1", phone: "9000033333", city: "Vijayawada", status: "Inactive" },
    { code: "VEN-004", name: "Prime 3PL Warehousing", category: "3PL", tier: "Tier 2", phone: "9000044444", city: "Chennai", status: "Active" },
    { code: "VEN-005", name: "TechFix Services", category: "Services", tier: "Tier 3", phone: "9000055555", city: "Bengaluru", status: "Inactive" },
    { code: "VEN-006", name: "Omega Raw Traders", category: "Raw Material", tier: "Tier 2", phone: "9000066666", city: "Hyderabad", status: "Active" },
    { code: "VEN-007", name: "BoxPro Packaging", category: "Packaging", tier: "Tier 1", phone: "9000077777", city: "Pune", status: "Active" },
    { code: "VEN-008", name: "SkyRoute Transport", category: "Transport", tier: "Tier 2", phone: "9000088888", city: "Delhi", status: "Active" },
    { code: "VEN-009", name: "ColdChain 3PL", category: "3PL", tier: "Tier 1", phone: "9000099999", city: "Mumbai", status: "Inactive" },
    { code: "VEN-010", name: "General Facility Services", category: "Services", tier: "Tier 2", phone: "9000000000", city: "Hyderabad", status: "Active" },
  ]);
  ...
  const [searchPhone, setSearchPhone] = useState(""); // ✅ added
  ...
  const [newVendor, setNewVendor] = useState<Pick<Vendor, "code" | "name" | "category" | "tier" | "phone" | "city" | "status">>({
    code: "",
    name: "",
  ...
  const filteredData = useMemo(() => {
    return data.filter((v) =>
      ...
      v.phone.toLowerCase().includes(searchPhone.toLowerCase()) && // ✅ added
      v.city.toLowerCase().includes(searchCity.toLowerCase()) &&   // ✅ added
  ...
  const stats = useMemo(() => {
    ...
    const byCategory = (cat: VendorCategory) => filteredData.filter((v) => v.category === cat).length;
  ...
  // CSV Export
  const exportToCSV = () => {
    const header = ["Vendor Code", "Vendor Name", "Category", "Tier", "Phone", "City", "Status"];
  ...
  const onAddVendor = () => {
    ...
    if (data.some((d) => d.code.trim().toLowerCase() === newVendor.code.trim().toLowerCase())) {
                    ...
                    >
                      ...
                      <td className="px-4 py-3 space-x-3">
                        <button
                          ...
                          onClick={() => alert(`Edit flow: open Vendor Form for ${v.code}`)}
                        >
                          Edit
                        </button>
                        <button
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewVendor((p) => ({ ...p, code: e.target.value }))}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewVendor((p) => ({ ...p, category: e.target.value as any }))}
                  className="mt-2 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white"
                >
                  <option value="Raw Material">Raw Material</option>
                  <option value="Packaging">Packaging</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewVendor((p) => ({ ...p, tier: e.target.value as any }))}
                  className="mt-2 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white"
                >
                  <option value="Tier 1">Tier 1</option>
                  <option value="Tier 2">Tier 2</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setNewVendor((p) => ({ ...p, status: e.target.value as any }))}
                  className="mt-2 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-white"
                >
                  <option value="Active">Active</option>
                  <option value="Inactive">Inactive</option>
